# BigRedRisk!
Risk board game with AI implemented in OCaml and an external python GUI API
...
many total players you would like to be in the game, and how many of those
players you would like to be controlled by an AI.

KNOWN ISSUES
--------------------------------------------------------------------------------
Lymp compiles best on the newest MacOS. It doesn't cooperate with Windows or the
VM very much. It may be worth noting that this game has only been proven to run
on Mac.