...
From the Lymp readme:
  ...
  Makefile. Try to install it using pip and pip3, so you should not have to 
  install it manually. If $ python3 -c "import pymongo" fails, you need to 
  install pymongo, maybe using sudo on pip or pip3."
...
many total players you would like to be in the game, how many of those players 
you would like to be controlled by an AI, and how aggressive you would like 
those AI's to be.
